...
namespace HistoricBattles.Controllers
{
    public class StagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DescriptionG,DescriptionE1,DescriptionE2,BattleId")] Stage stage)
        {
            if (ModelState.IsValid)
            {
                _context.Add(stage);
                await _context.SaveChangesAsync();
                return RedirectToAction("Create","Regiments");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DescriptionG,DescriptionE1,DescriptionE2")] Stage stage)
        {
            if (id != stage.Id)
            {
                return NotFound();
